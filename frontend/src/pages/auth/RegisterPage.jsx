        ...
        <div className="register-card">
          ...
          <form onSubmit={handleRegister} autoComplete="off" className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-[#005537] to-[#00704a] text-white font-extrabold text-xs py-3.5 rounded-full hover:brightness-110 shadow-lg hover:shadow-primary/30 transition-all flex items-center justify-center gap-2 disabled:opacity-50 mt-8"
            >
              {loading ? (
