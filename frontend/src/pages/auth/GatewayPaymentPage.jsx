...
export default function GatewayPaymentPage() {
  ...
  return (
    <MainLayout>
      ...
      <div className="min-h-screen bg-[#1a2b56] text-white py-16 px-6 select-none">
        <div className="max-w-4xl mx-auto bg-[#1a2b56] rounded-3xl border border-blue-500/30 shadow-2xl overflow-hidden text-white">
          {loading ? (
